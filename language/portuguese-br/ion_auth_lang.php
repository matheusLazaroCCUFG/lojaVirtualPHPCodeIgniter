...
$lang['email_forgot_password_heading']    	= '<h2>Perdeu sua senha? %s</h2>';
$lang['email_forgot_password_subheading'] 	= '<p>Você está recebendo este e-mail pois foi solicitado a recuperação de senha no site da Loja.</p> %s.<p><b>IMPORTANTE:</b> Se não foi você que solicitou ignore o e-mail. Seus dados permanecem seguros.</p>';
$lang['email_forgot_password_link']       	= '<p>Clique aqui para redefinir sua senha na Loja</p>';
