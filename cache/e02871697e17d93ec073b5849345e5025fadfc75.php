					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							<div class="section-title">
								...
								<a href="<?= base_url("checkout/login") ?>">
							...
							<form method="post" accept-charset="utf-8" class="form_checkout_pagar">
								...
								<label for="email">EMAIL para cadastro</label>
								<div class="form-group">
								...
								<div class="box-campo-endereco hide">
									...
									<div class="form-group">
										...
										<select  class="input" name="estado" id="estado" placeholder="Estado" >
											<option style="font-size: 25px" value="">Selecione...</option>
											<option style="font-size: 25px" value="AC">Acre</option>
											<option style="font-size: 25px" value="AL">Alagoas</option>
											<option style="font-size: 25px" value="AP">Amapá</option>
											<option style="font-size: 25px" value="AM">Amazonas</option>
											<option style="font-size: 25px" value="BA">Bahia</option>
											<option style="font-size: 25px" value="CE">Ceará</option>
											<option style="font-size: 25px" value="DF">Distrito Federal</option>
											<option style="font-size: 25px" value="ES">Espírito Santo</option>
											<option style="font-size: 25px" value="GO">Goiás</option>
											<option style="font-size: 25px" value="MA">Maranhão</option>
											<option style="font-size: 25px" value="MT">Mato Grosso</option>
											<option style="font-size: 25px" value="MS">Mato Grosso do Sul</option>
											<option style="font-size: 25px" value="MG">Minas Gerais</option>
											<option style="font-size: 25px" value="PA">Pará</option>
											<option style="font-size: 25px" value="PB">Paraíba</option>
											<option style="font-size: 25px" value="PR">Paraná</option>
											<option style="font-size: 25px" value="PE">Pernambuco</option>
											<option style="font-size: 25px" value="PI">Piauí</option>
											<option style="font-size: 25px" value="RJ">Rio de Janeiro</option>
											<option style="font-size: 25px" value="RN">Rio Grande do Norte</option>
											<option style="font-size: 25px" value="RS">Rio Grande do Sul</option>
											<option style="font-size: 25px" value="RO">Rondônia</option>
											<option style="font-size: 25px" value="RR">Roraima</option>
											<option style="font-size: 25px" value="SC">Santa Catarina</option>
											<option style="font-size: 25px" value="SP">São Paulo</option>
											<option style="font-size: 25px" value="SE">Sergipe</option>
											<option style="font-size: 25px" value="TO">Tocantins</option>
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							<div class="order-products">
								...
								<div class="order-col">
									<div><?=$produto['qty']?>x <?=$produto['nome']?>	<?= ($produto['tamanho'] && $produto['tamanho'] != '0' ? '<strong> - Tamanho: ' . $produto['tamanho'] . '</strong>' : '') ?> <?= ($produto['tipo'] && $produto['tipo'] != '0' ? '<strong> - Tipo: ' . $produto['tipo'] . '</strong>' : '') ?></div>
						...
						<div class="pagamento-cartao hide">
							...
							<form class="form_checkout_pagar" name="formCartao">
								...
								<div class="alert alert-info">Caso as parcelas não apareçam, redigite o CEP, opção de frete e número do cartão, respectivamente!</div>

								<div class=" form-group select-estilo">
									<label for="qtdParcelas" style="font-size: 15px; text-align: left; width: 100%">Parcelas (Selecione o Frete e digite as informações do Cartão)</label>
						...
						<div class="pagamento-transferencia hide">
							...
							<div id="ex1" class="modal">
								...
								Após a liberação do seu pedido, ele é coletado pelos Correios, e então começa a contar o prazo de entrega dos Correios.<br>(Excepcionalmente em alguns casos as entregas podem acontecer no sábado)
...
<?php echo $__env->make('viewsStore/principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/diogoj09/public_html/application/views/viewsStore/checkout.blade.php ENDPATH**/ ?>