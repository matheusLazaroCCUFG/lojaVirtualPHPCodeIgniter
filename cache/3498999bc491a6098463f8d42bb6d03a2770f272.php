<?php $__env->startSection('conteudo'); ?>
	...
	<script>
		...
		function changeFunc($i) {
			if ($i == 'maiorPreco'){
				window.open( url_loja + "todosMaiorPreco" ,'_self');
			}else
			if ($i == 'menorPreco'){
				window.open( url_loja + "todosMenorPreco",'_self');
			}else
			if($i == 'maisVendidos'){
				window.open( url_loja + "todosMaisVendidos",'_self');
			} else{
				window.open( url_loja + "todos",'_self');
			}
		}
	</script>
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3><span></span></h3><h3> Todos os produtos da Loja</h3>
			<!--/w3_short-->
		...
		<div class="col-md-14 products-right">
			...
			<div class="sort-grid">
				...
				<div class="form-group select-estilo-ordenacao-produtos">
					<label for="tipo_ordenacao">Ordenação</label>
...
<?php echo $__env->make('viewsStore/principal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/diogoj09/public_html/application/views/viewsStore/todosProdutos.blade.php ENDPATH**/ ?>