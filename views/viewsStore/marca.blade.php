...
@section('conteudo')
	...
	<script>
		...
		function changeFunc($i) {
			if ($i == 'maiorPreco'){
				window.open( url_loja + "marcaMaiorPreco/<?=$nomeMarca->meta_link?>" ,'_self');
			}else
			if ($i == 'menorPreco'){
				window.open( url_loja + "marcaMenorPreco/<?=$nomeMarca->meta_link?>",'_self');
			}else
			if ($i == 'maisVendidos'){
				window.open( url_loja + "marcaMaisVendidos/<?=$nomeMarca->meta_link?>",'_self');
			}else{
				window.open( url_loja + "marca/<?=$nomeMarca->meta_link?>",'_self');
			}
		}
	</script>
	...
	<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3><span>Coleção</span></h3><h3><?= $nomeMarca->nome_marca ?></h3>
			<!--/w3_short-->
			...
			<div class="col-md-14 products-right">
				...
				<div class="sort-grid">
					...
					<div class="form-group select-estilo-ordenacao-produtos">
						<label for="tipo_ordenacao">Ordenação da marca</label>
