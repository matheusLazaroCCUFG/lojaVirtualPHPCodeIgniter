			...
			<div class="row">
				...
				<!-- Order Details -->
					<div class="text-center col-md-14">
						...
						<a href="<?= ($_SESSION['url_banco'] ? $_SESSION['url_banco'] : '') ?>" title="Imprimir Boleto" target="_blank"><img src="<?=base_url("loja/images/ambienteTransferencia.png")?>" style="height: 150px">Clique aqui</a>
					</div>
					<br><br>
