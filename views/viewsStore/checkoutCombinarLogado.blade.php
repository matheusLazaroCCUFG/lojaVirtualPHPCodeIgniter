			...
			<div class="row">
				...
				<div class="col-md-7">
					...
					<div class="billing-details">
						<h3 class="text-center" style="color: darkgreen">Você está logado!</h3>
						<br>
						<hr>
						...
						<form method="post" accept-charset="utf-8" class="form_checkout_pagar">
							...
							<label for="email">Seu EMAIL (campo inalterável)</label>
							<div class="form-group">
							...
							<p style='color: darkgreen; font-size: 15px'> Obs: Entregas em Goiânia<br>Valor do frete: Entre R$ 20,00 e R$ 40,00. Conforme a localização.<br>Valor pago na entrega<br><br></p>
							...
							<div class="box-campo-endereco hide">
								...
								<div class="form-group">
									<input value="<?= ($usuario->endereco ? $usuario->endereco : "") ?>" class="input" type="text" name="endereco" placeholder="Endereço"  >
								</div>
								...
								<div class="form-group">
									<input value="<?= ($usuario->numero ? $usuario->numero : "") ?>" class="input input-numerico" type="text" name="numero" placeholder="Número" >
								</div>
								...
								<div class="form-group">
									...
									<select class="input" name="estado" id="estado">
										<option value="<?=$usuario->estado?>">
											...
											<?php if(strcmp($usuario->estado, "AP") == 0){ echo " Amapá";} ?>
											<?php if(strcmp($usuario->estado, "AM") == 0){ echo " Amazonas";} ?>
											<?php if(strcmp($usuario->estado, "BA") == 0){ echo " Bahia";} ?>
											<?php if(strcmp($usuario->estado, "CE") == 0){ echo " Ceará";} ?>
											<?php if(strcmp($usuario->estado, "DF") == 0){ echo " Distrito Federal";} ?>
											<?php if(strcmp($usuario->estado, "ES") == 0){ echo " Espírito Santo";} ?>
											<?php if(strcmp($usuario->estado, "GO") == 0){ echo " Goiás";} ?>
											<?php if(strcmp($usuario->estado, "MA") == 0){ echo " Maranhão";} ?>
											...
											<?php if(strcmp($usuario->estado, "PA") == 0){ echo " Pará";} ?>
											<?php if(strcmp($usuario->estado, "PB") == 0){ echo " Paraíba";} ?>
											<?php if(strcmp($usuario->estado, "PR") == 0){ echo " Paraná";} ?>
											<?php if(strcmp($usuario->estado, "PE") == 0){ echo " Pernambuco";} ?>
											<?php if(strcmp($usuario->estado, "PI") == 0){ echo " Piauí";} ?>
								...
								<div class="form -group">
									<input value="<?= ($usuario->telefone ? $usuario->telefone : "") ?>" class="input input_tel" type="tel" name="telefone" placeholder="Telefone" >
								</div>
								<br>
